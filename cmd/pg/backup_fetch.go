...
For information about pattern syntax view: https://golang.org/pkg/path/filepath/#Match`
	...
	SkipUnusedDescription         = "Skip files and tars with no useful data (requires reverse delta unpack)"
)
...
func init() {
	...
	backupFetchCmd.Flags().BoolVar(&skipUnusedTarsAndFiles, "skip-unused",
		false, SkipUnusedDescription)
