...
type IBackupFileUnwrapper interface {
	UnwrapNewFile(reader io.Reader, fileInfo *tar.Header, file *os.File) error
	UnwrapExistingFile(reader io.Reader, fileInfo *tar.Header, file *os.File) error
}
...
func (u *BackupFileUnwrapper) writeLocalFile(fileReader io.Reader, fileInfo *tar.Header, localFile *os.File) error {
