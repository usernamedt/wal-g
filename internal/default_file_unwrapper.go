...
// DefaultFileUnwrapper is used for default backups
type DefaultFileUnwrapper struct {
	BackupFileUnwrapper
}

func (u *DefaultFileUnwrapper) UnwrapNewFile(reader io.Reader, fileInfo *tar.Header, file *os.File) error {
...
func (u *DefaultFileUnwrapper) UnwrapExistingFile(reader io.Reader, fileInfo *tar.Header, file *os.File) error {
	if u.options.isIncremented {
